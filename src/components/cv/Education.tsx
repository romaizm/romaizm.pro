...
function EducationCard({ item, index }: { item: EducationItem; index: number }) {
  ...
  return (
    <motion.div
      ...
      className="bg-white dark:bg-neutral-800 rounded-xl p-5 shadow-sm border border-neutral-200 dark:border-neutral-700 h-full flex items-center"
    >
      <div className="flex items-start gap-4 w-full">
        <div className="w-11 h-11 bg-primary-100 dark:bg-primary-900/30 rounded-lg flex items-center justify-center flex-shrink-0">
